...
import com.qitech.spring.exception.*;
...
public enum ExceptionEnum {
     ...
     * 用户名密码错误
     */
    USERNAME_PWD_NOT_MATCHS(InvalidUsernameOrPwdException.class, HttpStatus.OK, ResultCode.USERNAME_PWD_ERROR),
